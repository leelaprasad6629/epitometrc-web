      ...
      <main id="main-content" className="pt-24 pb-16 font-sans bg-slate-50/50">
        <Container className="max-w-4xl bg-white border border-slate-100 rounded-3xl p-8 md:p-12 shadow-sm space-y-8">
          ...
          <div className="text-slate-600 text-sm leading-relaxed space-y-6">
            ...
            <p>
              EpitomeTRC reserves the right to suspend or terminate your account or access to any Service if you violate these Terms, without any obligation to refund fees already paid, in line with the No Refund Policy set out in Section 6 above. You may terminate your account at any time by writing to <a href="https://mail.google.com/mail/?view=cm&fs=1&to=info@epitometrc.com" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">info@epitometrc.com</a>; any fees already paid remain non-refundable in accordance with Section 6.
            </p>
