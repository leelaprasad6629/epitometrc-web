          ...
          <Container className="max-w-3xl space-y-8">
            ...
            <div className="flex justify-between items-center border-t border-b border-slate-100 py-4 font-sans text-xs font-bold text-slate-400 uppercase tracking-wider">
              <div className="flex gap-4">
                <button className="flex items-center gap-1.5 hover:text-rose-500 transition-colors cursor-pointer" type="button">
                  <Heart className="h-4.5 w-4.5" /> 42 Likes
                </button>
                <button className="flex items-center gap-1.5 hover:text-blue-500 transition-colors cursor-pointer" type="button">
                  <MessageSquare className="h-4.5 w-4.5" /> 8 Comments
                </button>
              </div>
              <button className="flex items-center gap-1.5 hover:text-orange-500 transition-colors cursor-pointer" type="button">
